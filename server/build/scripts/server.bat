...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\gson-2.10.1.jar


@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" edu.hitsz.server.BattleServer %*
